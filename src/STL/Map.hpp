...
namespace Epic
{
	...
	template<class K, 
			 ...
			 class A = Epic::DefaultSTLAllocatorFor<Pair, eSTLType::STLMap>>
	...
	template<class K, 
			 ...
			 class CompareFn = std::less<K>, 
			 class Pair = std::pair<const K, T>, 
			 class A = Epic::DefaultSTLAllocatorFor<Pair, eSTLType::STLMultiMap>>
	...
	template<class K, 
			 ...
			 class Pair = std::pair<const K, T>,
			 class A = Epic::DefaultSTLAllocatorFor<Pair, eSTLType::STLUnorderedMap>>
